<div style="font-family: Arial,sans-serif; text-transform: uppercase; margin: 0px auto;width: 100%; border: black 2px solid; padding: 5px;">
    ...
    <table width="100%" style="border-collapse:collapse;text-align:center; margin-top:5px;" border="1px">
        ...
        <tr>
            <td style="height: 10px; font-size: 0.6rem;  font-weight: bold">{{ \Carbon\Carbon::createFromFormat('Y-m-d', $nephrology->order->date_order)->format('d') }}</td>
            <td style="height: 10px; font-size: 0.6rem;  font-weight: bold">{{ \Carbon\Carbon::createFromFormat('Y-m-d', $nephrology->order->date_order)->format('m') }}</td>
            <td style="height: 10px; font-size: 0.6rem;  font-weight: bold">{{ \Carbon\Carbon::createFromFormat('Y-m-d', $nephrology->order->date_order)->format('Y') }}</td>
