...
<!--      <div class="form-group col-sm-12 col-lg-3">
        ...
        <div class="form-group col-sm-12 col-lg-4">
            ...
            <select name="fua_observacion" id="fua_observacion" class="form-control selectpicker" data-live-search="true" data-style="btn-info">
                ...
                <option value="PACIENTE PRESENTA ASTENIA POST DIALISIS, IMPOSIBILITADO AL MOMENTO DE FIRMAR">PACIENTE PRESENTA DISTENIA POST DIALISIS, IMPOSIBILITADO AL MOMENTO DE FIRMAR</option>
            </select>
        </div>
