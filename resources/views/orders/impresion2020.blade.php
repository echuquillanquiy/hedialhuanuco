    ...
    <table style="margin-top: -100px; width: 100%">
        ...
        <table width="100%">
          <tr>
            ...
            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem;">S.-</strong>  {{ $order->nurse->s }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem">O.-</strong> {{ $order->nurse->o }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem">A.-</strong> {{ $order->nurse->a }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem">P.-</strong> {{ $order->nurse->p }}</td>
            </tr>
