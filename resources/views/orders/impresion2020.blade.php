    ...
    <table style="margin-top: -100px; width: 100%">
        ...
        <table width="100%">
          <tr>
            ...
            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem; text-transform: uppercase">S.-</strong>  {{ $order->nurse->s }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem; text-transform: uppercase">O.-</strong> {{ $order->nurse->o }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem; text-transform: uppercase">A.-</strong> {{ $order->nurse->a }}</td>
            </tr>

            <tr>
                <td colspan="10" style="font-size: 0.7rem; border-bottom:1px dotted;" ><strong style="font-size:0.7rem; text-transform: uppercase">P.-</strong> {{ $order->nurse->p }}</td>
            </tr>
        ...
        <table width="100%" style="border-collapse:collapse;text-align:center; margin-top:0px" border="1px;">
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev2 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs2 }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="14">{{ $order->nurse->ptm3 }}</td>
              <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev3 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs3 }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="14">{{ $order->nurse->ptm4 }}</td>
              <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev4 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs4 }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="14">{{ $order->nurse->ptm5 }}</td>
              <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev5 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs5 }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="14">{{ $order->nurse->ptm6 }}</td>
              <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev6 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs6 }}</td>
          </tr>
          ...
          <tr style="font-size:0.7rem;">
            ...
            <td height="14">{{ $order->nurse->ptm7 }}</td>
              <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev7 }}</td>
            <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs7 }}</td>
          </tr>
            ...
            <tr style="font-size:0.7rem;">
                ...
                <td height="6" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->sol_hemodev8 }}</td>
                <td height="14" style="font-size:0.6rem !important; text-transform: uppercase">{{ $order->nurse->obs8 }}</td>
            </tr>
